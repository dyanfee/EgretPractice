...
declare module fairygui {
    class GProgressBar extends GComponent {
        ...
        protected _barStartX: number;
        protected _barStartY: number;
        protected _tweening: boolean;
        constructor();
...
declare module fairygui {
    class UIObjectFactory {
        ...
        private static componentItemClass;
        constructor();
        static setComponentItemClass(comp: any, type: any): void;
