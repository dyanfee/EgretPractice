...
(function (Collision) {
    var CircleLine = (function (_super) {
        ...
        CircleLine.prototype.myload = function () {
            var self = this;
        ...
        CircleLine.prototype.clickStart = function (e) {
            this._start.x = e.stageX;
            this._start.y = e.stageY;
            // this.drawLine();
            this.testRect2Line();
        };
        CircleLine.prototype.clickEnd = function (e) {
            this._end.x = e.stageX;
            this._end.y = e.stageY;
            // this.drawLine();
            this.testRect2Line();
        };
        CircleLine.prototype.clickCircle = function (e) {
            this._circle.x = e.stageX;
            this._circle.y = e.stageY;
        };
        CircleLine.prototype.clickRect = function (e) {
            this._rect.x = e.stageX;
            this._rect.y = e.stageY;
        };
        CircleLine.prototype.testRect2Line = function () {
        ...
        /** 线段与圆的碰撞检测 */
        CircleLine.line2Circle = function (p1x, p1y, p2x, p2y, circle) {
        ...
        CircleLine.line2Rect = function (p1x, p1y, p2x, p2y, rect) {
            var p1 = { x: p1x, y: p1y };
            var p2 = { x: p2x, y: p2y };
        ...
        CircleLine.line2line = function (p1, p2, c1, c2) {
        ...
        CircleLine.mult = function (a, b, c) {
            return (a.x - c.x) * (b.y - c.y) - (b.x - c.x) * (a.y - c.y);
        };
        /** 点与矩形区域 */
        CircleLine.rectContains = function (rect, x, y) {
            return rect.x <= x &&
                rect.x + rect.width >= x &&
                rect.y <= y &&
       ...
       * 线段和圆碰撞检测2
       */
        CircleLine.lineCircleHitTest = function (linePoint1, linePoint2, circlePoint, radius) {
         ...
         * 点到直线距离公式
         */
        CircleLine.disPointToLine = function (p, linePoint1, linePoint2) {
    ...
    Collision.CircleLine = CircleLine;
    __reflect(CircleLine.prototype, "Collision.CircleLine");
})(Collision || (Collision = {}));
