...
var TestP2RevoluteConstraint = (function (_super) {
    __extends(TestP2RevoluteConstraint, _super);
    function TestP2RevoluteConstraint() {
    ...
    TestP2RevoluteConstraint.prototype.onAdded2stage = function (e) {
        this.setup();
    };
    //setup
    TestP2RevoluteConstraint.prototype.setup = function () {
     ...
     * 创建场景物体
     */
    TestP2RevoluteConstraint.prototype.createSceneObjs = function () {
    ...
    //update step
    TestP2RevoluteConstraint.prototype.p2RunStep = function (dt) {
        if (dt < 10) {
            return;
        }
        if (dt > 1000) {
    ...
    TestP2RevoluteConstraint.prototype.createDebug = function () {
        //创建调试试图
     ...
     * 更新p2.World里面所有刚体的皮肤
     */
    TestP2RevoluteConstraint.prototype.updateWorldBodiesSkin = function (p2World) {
     ...
     * 更新目标刚体的皮肤
     */
    TestP2RevoluteConstraint.prototype.updateBodySkin = function (body) {
    ...
    */
    TestP2RevoluteConstraint.prototype.convertP2BodyAngleToEgret = function (body) {
        var result;
    ...
    * 把egret角度转换为p2角度
    */
    TestP2RevoluteConstraint.prototype.convertEgretAngleToP2 = function (angle) {
        var result;
    ...
    */
    TestP2RevoluteConstraint.prototype.convertP2ValueToEgret = function (value) {
    ...
    * 适合如 x,width,height的转换，y值不适合
    */
    TestP2RevoluteConstraint.prototype.convertEgretValueToP2 = function (value) {
        return value / this.factor;
    };
    /**
    * 把egretY值转换到p2Y值，仅适合y转换
    */
    TestP2RevoluteConstraint.prototype.convertEgretY_To_P2Y = function (egretY) {
        return (this.worldRect.height - egretY) / this.factor;
    };
    /**
    * 把p2y值转换到egretY值，仅适合y转换
    */
    TestP2RevoluteConstraint.prototype.convertP2Y_To_EgretY = function (p2Y) {
        return this.worldRect.height - p2Y * this.factor;
    };
    /**
    * 在物理世界创建一个矩形刚体，显示cube矢量图形
    */
    TestP2RevoluteConstraint.prototype.addOneBox = function (p2World, ctn, px, py, pw, ph, pAngle, type) {
        //在物理世界中的位置
    ...
    * 返回的图形锚点位于图形中心
    */
    TestP2RevoluteConstraint.prototype.createBoxSkin = function (width, height) {
    ...
    return TestP2RevoluteConstraint;
}(egret.Sprite));
__reflect(TestP2RevoluteConstraint.prototype, "TestP2RevoluteConstraint");
//# sourceMappingURL=demoEgret.js.map